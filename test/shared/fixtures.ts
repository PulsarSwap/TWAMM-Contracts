...
export async function pairFixture(provider: Web3Provider, [wallet]: Wallet[]): Promise<PairFixture> {
  ...
  const token0 = await deployContract(wallet, ERC20, [expandTo18Decimals(10000)], overrides)
  const token1 = await deployContract(wallet, ERC20, [expandTo18Decimals(10000)], overrides)
