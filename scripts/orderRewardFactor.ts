...
async function main() {
  ...
  let orderRewardFactorAtExpiring: BigNumber;
  ...
  [orderRewardFactorAtSubmission, orderRewardFactorAtExpiring] =
    await pair.getOrderRewardFactor(orderId);
  console.log(
    "orderRewardFactorAtSubmission:",
    orderRewardFactorAtSubmission.toString()
  );
  console.log(
    "orderRewardFactorAtExpiring:",
    orderRewardFactorAtExpiring.toString()
  );
}
