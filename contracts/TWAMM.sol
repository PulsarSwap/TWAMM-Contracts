...
contract TWAMM is ITWAMM {
    ...
    constructor(address _factory, address _WETH, address _twammSwap, address _twammTermSwap, address _twammLiquidity) {
        factory = _factory;
        WETH = _WETH;
        IFactory(factory).initialize(address(this), _twammSwap, _twammTermSwap, _twammLiquidity);
    }
