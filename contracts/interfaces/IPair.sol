...
interface IPair {
    ...
    function provideInitialLiquidity(address to, uint256 amountA, uint256 amountB) external;
    ...
    function longTermSwapFromAToB(address sender, uint256 amountAIn, uint256 numberOfBlockIntervals) external;
    function swapFromBToA(address sender, uint256 amountBIn) external;
    function longTermSwapFromBToA(address sender, uint256 amountBIn, uint256 numberOfBlockIntervals) external;
